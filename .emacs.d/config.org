...
#+begin_src emacs-lisp
  (use-package general
    ...
    (vnmd/leader-keys
      ...
      "l d" '(lsp-bridge-popup-documentation :wk "Documentation")
      "l c" '(comment-line :wk "Comment line")
      "l f" '(lsp-bridge-code-format :wk "Format Code")
      "l g" '(lsp-bridge-find-type-def :wk "Goto Definition")
      "l i" '(lsp-bridge-find-impl :wk "Implementation")
      "l n" '(lsp-bridge-rename :wk "(Re)Name")
      "l r" '(lsp-bridge-find-references :wk "References")
      "l w" '(lsp-bridge-diagnostic-list :wk "Show Diagnostics"))
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-bridge
    ...
    (setq
     ...
     lsp-bridge-diagnostic-fetch-idle 0.2
     acm-doc-frame-max-lines 50))
